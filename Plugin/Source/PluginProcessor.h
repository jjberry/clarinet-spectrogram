...
private:
    ...
    static constexpr int kSilenceHoldFrames = 12;  // hold pitch for ~12 FFT frames before releasing
    static constexpr float kPitchEmaAlpha   = 0.2f; // lower = smoother but slower to track
